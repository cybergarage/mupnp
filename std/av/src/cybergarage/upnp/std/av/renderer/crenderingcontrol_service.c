...
static char *CG_UPNP_DMR_RENDERINGCONTROL_SERVICE_DESCRIPTION = 
...
/****************************************
* cg_upnp_dmr_renderingctrl_actionreceived
****************************************/

BOOL cg_upnp_dmr_renderingctrl_actionreceived(CgUpnpAction *action)
{
...
/****************************************
* cg_upnp_dmr_renderingctrl_init
****************************************/

BOOL cg_upnp_dmr_renderingctrl_init(CgUpnpMediaRenderer *dmr)
{
	CgUpnpDevice *dev;
	CgUpnpService *service;
	CgUpnpAction *action;

	dev = cg_upnp_dmr_getdevice(dmr);
	if (!dev)
		return FALSE;

	service = cg_upnp_device_getservicebytype(dev, CG_UPNP_DMR_RENDERINGCONTROL_SERVICE_TYPE);
	if (!service)
		return FALSE;
	
	if (cg_upnp_service_parsedescription(service, CG_UPNP_DMR_RENDERINGCONTROL_SERVICE_DESCRIPTION, cg_strlen(CG_UPNP_DMR_RENDERINGCONTROL_SERVICE_DESCRIPTION)) == FALSE)
		return FALSE;
