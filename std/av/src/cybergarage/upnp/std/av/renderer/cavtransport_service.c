...
static char *CG_UPNP_DMR_AVTRANSPORT_SERVICE_DESCRIPTION = 
...
/****************************************
* cg_upnp_dmr_avtransport_actionreceived
****************************************/

BOOL cg_upnp_dmr_avtransport_actionreceived(CgUpnpAction *action)
{
...
/****************************************
* cg_upnp_dmr_avtransport_init
****************************************/

BOOL cg_upnp_dmr_avtransport_init(CgUpnpMediaRenderer *dmr)
{
	CgUpnpDevice *dev;
	...
	service = cg_upnp_device_getservicebytype(dev, CG_UPNP_DMR_AVTRANSPORT_SERVICE_TYPE);
	if (!service)
		return FALSE;
	
	if (cg_upnp_service_parsedescription(service, CG_UPNP_DMR_AVTRANSPORT_SERVICE_DESCRIPTION, cg_strlen(CG_UPNP_DMR_AVTRANSPORT_SERVICE_DESCRIPTION)) == FALSE)
		return FALSE;
