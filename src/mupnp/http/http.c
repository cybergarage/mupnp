...
const char *mupnp_http_statuscode2reasonphrase(const int code)
{
	...
	switch (code) 
	{
		case 100: return MUPNP_HTTP_REASON_PHRASE_100;
		case 101: return MUPNP_HTTP_REASON_PHRASE_101;
		case 200: return MUPNP_HTTP_REASON_PHRASE_200;
		case 201: return MUPNP_HTTP_REASON_PHRASE_201;
		case 202: return MUPNP_HTTP_REASON_PHRASE_202;
		case 203: return MUPNP_HTTP_REASON_PHRASE_203;
		case 204: return MUPNP_HTTP_REASON_PHRASE_204;
		case 205: return MUPNP_HTTP_REASON_PHRASE_205;
		case 206: return MUPNP_HTTP_REASON_PHRASE_206;
		case 300: return MUPNP_HTTP_REASON_PHRASE_300;
		case 301: return MUPNP_HTTP_REASON_PHRASE_301;
		case 302: return MUPNP_HTTP_REASON_PHRASE_302;
		case 303: return MUPNP_HTTP_REASON_PHRASE_303;
		case 304: return MUPNP_HTTP_REASON_PHRASE_304;
		case 305: return MUPNP_HTTP_REASON_PHRASE_305;
		case 307: return MUPNP_HTTP_REASON_PHRASE_307;
		case 400: return MUPNP_HTTP_REASON_PHRASE_400;
		case 401: return MUPNP_HTTP_REASON_PHRASE_401;
		case 402: return MUPNP_HTTP_REASON_PHRASE_402;
		case 403: return MUPNP_HTTP_REASON_PHRASE_403;
		case 404: return MUPNP_HTTP_REASON_PHRASE_404;
		case 405: return MUPNP_HTTP_REASON_PHRASE_405;
		case 406: return MUPNP_HTTP_REASON_PHRASE_406;
		case 407: return MUPNP_HTTP_REASON_PHRASE_407;
		case 408: return MUPNP_HTTP_REASON_PHRASE_408;
		case 409: return MUPNP_HTTP_REASON_PHRASE_409;
		case 410: return MUPNP_HTTP_REASON_PHRASE_410;
		case 411: return MUPNP_HTTP_REASON_PHRASE_411;
		case 412: return MUPNP_HTTP_REASON_PHRASE_412;
		case 413: return MUPNP_HTTP_REASON_PHRASE_413;
		case 414: return MUPNP_HTTP_REASON_PHRASE_414;
		case 415: return MUPNP_HTTP_REASON_PHRASE_415;
		case 416: return MUPNP_HTTP_REASON_PHRASE_416;
		case 417: return MUPNP_HTTP_REASON_PHRASE_417;
		case 500: return MUPNP_HTTP_REASON_PHRASE_500;
		case 501: return MUPNP_HTTP_REASON_PHRASE_501;
		case 502: return MUPNP_HTTP_REASON_PHRASE_502;
		case 503: return MUPNP_HTTP_REASON_PHRASE_503;
		case 504: return MUPNP_HTTP_REASON_PHRASE_504;
		case 505: return MUPNP_HTTP_REASON_PHRASE_505;
		default: return MUPNP_HTTP_REASON_PHRASE_UNKNOWN;
	}
