...
char* testDeviceDescription = "<?xml version=\"1.0\" ?>\n"
...
char* testServiceDescription = "<?xml version=\"1.0\"?>\n"
...
mUpnpDevice* upnp_test_device_new()
{
  ...
  if (mupnp_device_parsedescription(testDev, testDeviceDescription, strlen(testDeviceDescription)) == false) {
  ...
  if (mupnp_service_parsedescription(testService, testServiceDescription, strlen(testServiceDescription)) == false) {
    mupnp_device_delete(testDev);
    return NULL;
  }
